...
void DefaultSceneLayer::_CreateScene()
{
	...
	if (loadScene && std::filesystem::exists("scene.json")) {
		...
		MeshResource::Sptr HandMesh   = ResourceManager::CreateAsset<MeshResource>("Handle.obj");

		// Load in some textures
		Texture2D::Sptr    boxTexture   = ResourceManager::CreateAsset<Texture2D>("textures/A1.png");
		Texture2D::Sptr    boxSpec      = ResourceManager::CreateAsset<Texture2D>("textures/box-specular.png");
		Texture2D::Sptr    monkeyTex    = ResourceManager::CreateAsset<Texture2D>("textures/monkey-uvMap.png");
		Texture2D::Sptr    leafTex      = ResourceManager::CreateAsset<Texture2D>("textures/leaves.png");
		Texture2D::Sptr    PuckTex		= ResourceManager::CreateAsset<Texture2D>("textures/PuckSkin1.png");
		Texture2D::Sptr    HandTex		= ResourceManager::CreateAsset<Texture2D>("textures/Player2.png");
...
#pragma endregion 
		...
		{
			monkeyMaterial->Name = "Puck";
			monkeyMaterial->Set("u_Material.AlbedoMap", PuckTex);
			monkeyMaterial->Set("u_Material.NormalMap", normalMapDefault);
			monkeyMaterial->Set("u_Material.Shininess", 0.5f);
		}

		Material::Sptr monkeyMaterial2 = ResourceManager::CreateAsset<Material>(deferredForward);
		{
			monkeyMaterial2->Name = "Hand";
			monkeyMaterial2->Set("u_Material.AlbedoMap", HandTex);
			monkeyMaterial2->Set("u_Material.NormalMap", normalMapDefault);
			monkeyMaterial2->Set("u_Material.Shininess", 0.5f);
		}
		...
		GameObject::Sptr monkey1 = scene->CreateGameObject("Puck");
		{
			// Set position in the scene
			monkey1->SetPostion(glm::vec3(10.5f, 0.0f, 10.0f));
			monkey1->SetRotation(glm::vec3(90.0f, 90.0f, 0.0f));
		...
		GameObject::Sptr ship = scene->CreateGameObject("Handle");
		{
			// Set position in the scene
			ship->SetPostion(glm::vec3(100.0f, 0.0f, 4.0f));
			ship->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
		...
		GameObject::Sptr ship2 = scene->CreateGameObject("Handle");
		{
			// Set position in the scene
			ship2->SetPostion(glm::vec3(-100.0f, 0.0f, 4.0f));
			ship2->SetRotation(glm::vec3(90.0f, 0.0f, 0.0f));
			ship2->SetScale(glm::vec3(0.1f));

			// Create and attach a renderer for the monkey
			RenderComponent::Sptr renderer = ship2->Add<RenderComponent>();
			renderer->SetMesh(HandMesh);
			renderer->SetMaterial(monkeyMaterial2);
		}
